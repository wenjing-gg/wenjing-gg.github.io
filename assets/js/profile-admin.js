(function () {
  ...
  function introSection(data) {
    return [
      ...
      area("主要介绍", "intro.lead", data.intro.lead, "请输入个人介绍主文案"),
      field("导师名称", "intro.mentorName", data.intro.mentorName, "例如：秦飞巍教授"),
      field("导师主页", "intro.mentorUrl", data.intro.mentorUrl, "https://..."),
      area("导师说明 / 研究概述", "intro.mentorSummary", data.intro.mentorSummary, "请输入导师或研究方向介绍"),
      field("联系电话", "intro.phone", data.intro.phone, "请输入联系电话"),
      "</div>",
      '<div class="admin-section__inline-head"><h3>邮箱</h3><button class="admin-button" type="button" data-add-item="intro.emails" data-template="text">新增邮箱</button></div>',
